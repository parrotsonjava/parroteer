...
import com.dronecontrol.droneapi.commands.composed.*;
...
import com.dronecontrol.droneapi.data.enums.*;
...
public class ParrotDroneController implements DroneController {
    private static final int NUMBER_OF_THREADS = 1;

    private final Logger logger = Logger.getLogger(ParrotDroneController.class);
    ...
    public static DroneController build() {
        return ParrotControlContext.getBean(ParrotDroneController.class);
    }

    @Inject
    public ParrotDroneController(ReadyStateListenerComponent readyStateListenerComponent, ErrorListenerComponent errorListenerComponent,
